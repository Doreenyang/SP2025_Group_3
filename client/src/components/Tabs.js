...
function TabsComponent() {
  ...
  useEffect(() => {
      ...
      try {
        ...
        if (decoded && decoded.id) {
          ...
          if (decoded.username) {
            ...
            // Use email before @ as username if no username/name is available
            setUsername(decoded.email.split("@")[0])
          }

          // Fetch user details if username not in token
          if (!decoded.username && !decoded.name && !decoded.email) {
    ...
    // Simulate unread messages (remove in production and use real data)
        ...
        <Toolbar sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", width: "100%" }}>
          ...
          {isMobile ? (
            ...
            <>
              ...
              {/* Right Section (User Info, Coin Balance & Logout) */}
              <Box sx={{ display: "flex", alignItems: "center" }}>
                {/* Username display */}
                <UserInfo />
                ...
                <Tooltip title="Messages" arrow>
                  ...
                  >
                    ...
                    {/* {unreadMessages === 0 && <ChatBubbleIcon />} */}
