...
function Dashboard() {
  ...
  const [heroBackgrounds, setHeroBackgrounds] = useState([
    "https://images.unsplash.com/photo-1586902197503-e71026292412?q=80&w=3544&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", // Original image
    "https://images.unsplash.com/photo-1614358519874-0101b3c26d05?q=80&w=3538&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", // Dark with red elements
    "https://images.unsplash.com/photo-1489011397388-494518edf378?q=80&w=3474&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", // Dark elegant background
    "https://images.unsplash.com/photo-1523712999610-f77fbcfc3843?q=80&w=3540&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", // Another elegant dark background
  ])
  ...
  const fetchProductCounts = async (token) => {
    try {
      ...
      const response = await axios.get("http://34.67.85.189:3000/api/products/counts")
      ...
      for (const season of seasons) {
        try {
          const seasonResponse = await axios.get(`http://34.67.85.189:3000/api/products/${season}`)
  ...
  useEffect(() => {
    const fetchDashboard = async () => {
      try {
        ...
        try {
          const response = await axios.get("http://34.67.85.189:3000/api/dashboard")
  ...
  return (
    ...
    >
      ...
      {/* Hero Section with Parallax Effect and Background Slideshow */}
      <div
      ...
      >
        ...
        {/* Background Slideshow Navigation Dots */}
        <div
          style={{
            position: "absolute",
            bottom: "100px",
        ...
        >
          {heroBackgrounds.map((_, index) => (
            <button
              ...
              style={{
                width: currentHeroBackground === index ? "30px" : "10px",
                height: "10px",
                borderRadius: "10px",
                backgroundColor: currentHeroBackground === index ? "white" : "rgba(255, 255, 255, 0.5)",
                border: "none",
                cursor: "pointer",
